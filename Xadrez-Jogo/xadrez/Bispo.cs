...
namespace Xadrez_Jogo.xadrez
{
    class Bispo : Peca
    {
         ...
         * aqui é colocada a regra de movimentãção do Bispo
         * esse metodo está atribuindo as regras para onde o bispo pode se mexer.
         * retorna uma matriz com os movimento possiveis de um Bispo
         */
